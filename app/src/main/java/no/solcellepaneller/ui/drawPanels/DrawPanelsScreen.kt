package no.solcellepaneller.ui.drawPanels
...
@Composable
fun DrawPanelsScreen(navController: NavController) {
    ...
    { contentPadding ->
        Column(
            ...
            Text("Tegn Paneler")
            Button(onClick = { navController.navigate("result") }) { Text("Gå til Resultater") }
